...
interface Addon_TestProviderType<Details extends {
    [key: string]: any;
} = NonNullable<unknown>, Config extends {
    [key: string]: any;
} = NonNullable<unknown>> {
    ...
    stateUpdater?: (state: TestProviderConfig & Addon_TestProviderState<Details, Config>, update: Partial<Addon_TestProviderState<Details, Config>>) => void | Partial<TestProviderConfig & Addon_TestProviderState<Details, Config>>;
    runnable?: boolean;
    watchable?: boolean;
}
